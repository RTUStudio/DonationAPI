...
import kr.rtustudio.donation.service.chzzk.official.net.data.RestrictionDeleteRequest;
...
public class RestrictionDeleteExecutor implements HttpRequestExecutor<RestrictionDeleteRequest, Void, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<Void> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull RestrictionDeleteRequest requestInst) {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new RuntimeException("Failed to execute RestrictionDelete request", e);
        }
    }
