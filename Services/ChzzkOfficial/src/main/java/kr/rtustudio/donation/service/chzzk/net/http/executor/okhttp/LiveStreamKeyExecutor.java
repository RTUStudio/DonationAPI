...
import kr.rtustudio.donation.service.chzzk.net.data.LiveStreamKeyRequest;
import kr.rtustudio.donation.service.chzzk.net.data.LiveStreamKeyResponse;
...
public class LiveStreamKeyExecutor implements HttpRequestExecutor<LiveStreamKeyRequest, LiveStreamKeyResponse, OkHttpClient> {
    ...
    public @NotNull Optional<LiveStreamKeyResponse> execute(
            @NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull LiveStreamKeyRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute LiveStreamKey request", e);
        }
    }
