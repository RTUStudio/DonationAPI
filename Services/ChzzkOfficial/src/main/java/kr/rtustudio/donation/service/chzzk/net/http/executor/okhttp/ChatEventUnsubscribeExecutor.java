...
import kr.rtustudio.donation.service.chzzk.net.data.ChatEventUnsubscribeRequest;
...
public class ChatEventUnsubscribeExecutor implements HttpRequestExecutor<ChatEventUnsubscribeRequest, Void, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<Void> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull ChatEventUnsubscribeRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute ChatEventUnsubscribe request", e);
        }
    }
