...
import kr.rtustudio.donation.service.chzzk.official.net.data.AuthorizationCodeRequest;
import kr.rtustudio.donation.service.chzzk.official.net.data.AuthorizationCodeResponse;
...
public class AuthorizationCodeExecutor implements HttpRequestExecutor<AuthorizationCodeRequest, AuthorizationCodeResponse, OkHttpClient> {
    ...
    public @NotNull Optional<AuthorizationCodeResponse> execute(
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new RuntimeException("Failed to execute AuthorizationCode request", e);
        }
    }
