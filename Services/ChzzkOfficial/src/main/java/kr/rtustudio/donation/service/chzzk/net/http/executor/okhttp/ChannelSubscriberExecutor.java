...
import kr.rtustudio.donation.service.chzzk.net.data.ChannelSubscriberRequest;
...
public class ChannelSubscriberExecutor implements HttpRequestExecutor<ChannelSubscriberRequest, ChannelSubscriberResponse, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<ChannelSubscriberResponse> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull ChannelSubscriberRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute ChannelSubscriber request", e);
        }
    }
