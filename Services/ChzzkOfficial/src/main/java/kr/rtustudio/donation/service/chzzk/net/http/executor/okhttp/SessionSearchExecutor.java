...
public class SessionSearchExecutor implements HttpRequestExecutor<SessionSearchRequest, SessionSearchResponse, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<SessionSearchResponse> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull SessionSearchRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute SessionSearch request", e);
        }
    }
