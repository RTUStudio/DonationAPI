...
import kr.rtustudio.donation.service.chzzk.net.data.ChatMessageSendRequest;
import kr.rtustudio.donation.service.chzzk.net.data.ChatMessageSendResponse;
...
public class ChatMessageSendExecutor implements HttpRequestExecutor<ChatMessageSendRequest, ChatMessageSendResponse, OkHttpClient> {
    ...
    public @NotNull Optional<ChatMessageSendResponse> execute(
            @NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull ChatMessageSendRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute ChatMessageSend request", e);
        }
    }
