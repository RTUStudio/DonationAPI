...
import kr.rtustudio.donation.service.chzzk.net.data.DonationEventUnsubscribeRequest;
...
public class DonationEventUnsubscribeExecutor implements HttpRequestExecutor<DonationEventUnsubscribeRequest, Void, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<Void> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull DonationEventUnsubscribeRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute DonationEventUnsubscribe request", e);
        }
    }
