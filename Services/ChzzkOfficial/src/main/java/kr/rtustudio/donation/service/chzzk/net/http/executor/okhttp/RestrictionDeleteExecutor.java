...
import kr.rtustudio.donation.service.chzzk.net.data.RestrictionDeleteRequest;
...
public class RestrictionDeleteExecutor implements HttpRequestExecutor<RestrictionDeleteRequest, Void, OkHttpClient> {

    @Override
    public @NotNull Optional<Void> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull RestrictionDeleteRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute RestrictionDelete request", e);
        }
    }
