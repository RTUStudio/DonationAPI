...
import kr.rtustudio.donation.service.chzzk.official.net.data.CategorySearchRequest;
import kr.rtustudio.donation.service.chzzk.official.net.data.CategorySearchResponse;
...
public class CategorySearchExecutor implements HttpRequestExecutor<CategorySearchRequest, CategorySearchResponse, OkHttpClient> {
    ...
    public @NotNull Optional<CategorySearchResponse> execute(
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new RuntimeException("Failed to execute CategorySearch request", e);
        }
    }
