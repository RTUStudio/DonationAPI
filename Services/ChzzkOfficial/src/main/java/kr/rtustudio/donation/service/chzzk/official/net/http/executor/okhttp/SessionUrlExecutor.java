...
import kr.rtustudio.donation.service.chzzk.official.net.data.SessionUrlRequest;
import kr.rtustudio.donation.service.chzzk.official.net.data.SessionUrlResponse;
...
public class SessionUrlExecutor implements HttpRequestExecutor<SessionUrlRequest, SessionUrlResponse, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<SessionUrlResponse> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull SessionUrlRequest requestInst) {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new RuntimeException("Failed to execute SessionUrl request", e);
        }
    }
