...
public class ChannelManagerExecutor implements HttpRequestExecutor<ChannelManagerRequest, ChannelManagerResponse, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<ChannelManagerResponse> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull ChannelManagerRequest requestInst) {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new RuntimeException("Failed to execute ChannelManager request", e);
        }
    }
