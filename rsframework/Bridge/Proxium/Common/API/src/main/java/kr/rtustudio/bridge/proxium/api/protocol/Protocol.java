...
public class Protocol {
    ...
    @Getter
    private final BridgeChannel channel;
    @Getter
    ...
    @EqualsAndHashCode.Exclude
    private Supplier<? extends ConnectionHandler> serverHandlerFactory;
    @EqualsAndHashCode.Exclude
    private Supplier<? extends ConnectionHandler> proxyHandlerFactory;
    @EqualsAndHashCode.Exclude
    private Supplier<? extends ServerAuthHandler> serverAuthFactory;
    @EqualsAndHashCode.Exclude
    private Supplier<? extends ProxyAuthHandler> proxyAuthFactory;
