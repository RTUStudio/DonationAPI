...
//import kr.rtustudio.donation.common.service.ssapi.data.RoomInfo;
//import kr.rtustudio.donation.common.service.ssapi.data.RoomUser;
...
//        CompletableFuture<RoomInfo> result = getPlugin().getDonationAPI().info();
