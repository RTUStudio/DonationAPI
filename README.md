...
[![Version](https://img.shields.io/badge/version-1.0.4-blue.svg)](https://github.com/RTUStudio/DonationAPI)
...
#### 설치 방법
1. 최신 릴리즈의 `DonationAPI-1.0.4.jar` 파일을 서버의 `plugins/` 폴더에 넣습니다.
...
dependencies {
    compileOnly("kr.rtustudio:donationapi:1.0.4")
}
```
...
컴파일된 파일은 `builds/plugin/DonationAPI-1.0.4.jar` 에 생성됩니다.
