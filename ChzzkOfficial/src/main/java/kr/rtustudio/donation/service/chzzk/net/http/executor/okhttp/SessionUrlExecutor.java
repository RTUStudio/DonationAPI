...
import kr.rtustudio.donation.service.chzzk.net.data.SessionUrlRequest;
import kr.rtustudio.donation.service.chzzk.net.data.SessionUrlResponse;
...
public class SessionUrlExecutor implements HttpRequestExecutor<SessionUrlRequest, SessionUrlResponse, OkHttpClient> {

    @Override
    public @NotNull Optional<SessionUrlResponse> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull SessionUrlRequest requestInst) throws HttpRequestExecutionException {
        Request request = new Request.Builder()
                .url(Constants.OPENAPI_URL + "/open/v1/sessions/auth")
                .get()
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute SessionUrl request", e);
        }
    }
