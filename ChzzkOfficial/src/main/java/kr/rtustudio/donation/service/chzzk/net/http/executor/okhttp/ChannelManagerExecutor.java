...
import kr.rtustudio.donation.service.chzzk.net.data.ChannelManagerRequest;
import kr.rtustudio.donation.service.chzzk.net.data.ChannelManagerResponse;
...
public class ChannelManagerExecutor implements HttpRequestExecutor<ChannelManagerRequest, ChannelManagerResponse, OkHttpClient> {

    @Override
    public @NotNull Optional<ChannelManagerResponse> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull ChannelManagerRequest requestInst) throws HttpRequestExecutionException {
        HttpUrl url = HttpUrl.get(Constants.OPENAPI_URL + "/open/v1/channels/streaming-roles")
                .newBuilder()
                .build();
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute ChannelManager request", e);
        }
    }
