...
public class RestrictionSearchExecutor implements HttpRequestExecutor<RestrictionSearchRequest, RestrictionSearchResponse, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<RestrictionSearchResponse> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull RestrictionSearchRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute RestrictionSearch request", e);
        }
    }
