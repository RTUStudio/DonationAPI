...
public class RestrictionAddExecutor implements HttpRequestExecutor<RestrictionAddRequest, Void, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<Void> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull RestrictionAddRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute RestrictionAdd request", e);
        }
    }
