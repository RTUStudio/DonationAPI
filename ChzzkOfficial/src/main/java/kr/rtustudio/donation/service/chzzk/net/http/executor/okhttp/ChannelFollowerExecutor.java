...
import kr.rtustudio.donation.service.chzzk.net.data.ChannelFollowerRequest;
import kr.rtustudio.donation.service.chzzk.net.data.ChannelFollowerResponse;
...
public class ChannelFollowerExecutor implements HttpRequestExecutor<ChannelFollowerRequest, ChannelFollowerResponse, OkHttpClient> {
    ...
    @Override
    public @NotNull Optional<ChannelFollowerResponse> execute(@NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull ChannelFollowerRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute ChannelFollower request", e);
        }
    }
