...
import kr.rtustudio.donation.service.chzzk.net.data.ChatAnnouncementSetRequest;
...
public class ChatAnnouncementSetExecutor implements HttpRequestExecutor<ChatAnnouncementSetRequest, Void, OkHttpClient> {
    ...
    public @NotNull Optional<Void> execute(
            @NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull ChatAnnouncementSetRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute ChatAnnouncementSet request", e);
        }
    }
