...
import kr.rtustudio.donation.service.chzzk.net.data.LiveSearchRequest;
import kr.rtustudio.donation.service.chzzk.net.data.LiveSearchResponse;
...
public class LiveSearchExecutor implements HttpRequestExecutor<LiveSearchRequest, LiveSearchResponse, OkHttpClient> {
    ...
    public @NotNull Optional<LiveSearchResponse> execute(
            @NotNull ChzzkHttpClient<OkHttpClient> client, @NotNull LiveSearchRequest requestInst) throws HttpRequestExecutionException {
        ...
        try (Response response = client.getNativeHttpClient().newCall(request).execute()) {
            ...
            throw new HttpRequestExecutionException("Failed to execute LiveSearch request", e);
        }
    }
